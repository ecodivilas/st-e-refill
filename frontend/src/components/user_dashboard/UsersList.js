            ...
            ? records.map((order) => {
                  return {
                      ...
                      is_paid: order.is_paid ? (
                          <button className="py-1 px-5 text-xm rounded-lg text-white font-medium bg-lime-600">
                              Paid
                          </button>
                      ) : (
                          <button className="py-1 px-5 text-xm rounded-lg text-black font-medium bg-yellow-400">
                              Unpaid
                          </button>
                      ),
