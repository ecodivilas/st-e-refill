    ...
    >
      ...
      <div className="flex flex-col justify-end w-5/12 h-28 gap-3">
        <div className="flex justify-center h-14">
          <button type="button" onClick={() => navigate('/login')} className="text-white bg-slate-900 hover:bg-orange-500 focus:ring-4 focus:bg-slate-500 font-medium text-lg px-5 py-2.5 w-2/6">Order Now</button>
        </div>
