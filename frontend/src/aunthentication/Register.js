                                ...
                                {isToggle ? ( 
                                     <>
                                        ...
                                        <div className="flex items-end h-16 grow mt-2">
                                            <button type="submit" className="grow rounded-sm text-white bg-primary-600 hover:bg-primary-700 font-medium text-sm px-2 text-center dark:bg-green-600 dark:hover:bg-orange-700 h-10"
                                    >
                                        Register Now
                                            </button> 
                                        </div>
