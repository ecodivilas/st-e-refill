...
function Register() {
    ...
    const handleSubmit = (e) => {
        ...
        if (isPassed()) {
            registerUser(defaultUserValues, defaultAddressValues)
                ...
                .catch((error) => alert("Didn't Went Through"))
    ...
    return (
        <div>
            ...
            >
                <div className="!w-[60vw] h-[100vh] flex justify-start z-10 ml-8">
                            ...
                            <div className="p-6 h-[90vh] space-y-6 md:space-y-6 sm:p-8">
                                ...
                                <form className="" onSubmit={handleSubmit}>
                                    <div>
                                        ...
                                        {isToggle ? (
                                            <>
                                                <div className="pt-6 flex items-end text-white text-xs font-small">
                                                    Address will be your
                                                    delivery address for your
                                                    orders.
                                                </div>
                                                <div className="flex items-end h-16 grow mt-2">
                                                    <button
                                                        type="submit"
                                                        className="grow rounded-sm text-white bg-primary-600 hover:bg-primary-700 font-medium text-sm px-2 text-center dark:bg-green-600 dark:hover:bg-green-700 h-10"
                                                    >
                                                        Register Now
                                                    </button>
                                                </div>
